...
class AdicionarClientesController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
...
//        let parameters = Clientes_Model(username: username, email: email, password: password, profileImageName: "user", date: "08:00" )
        
        let parameters = Clientes_Model(username: username, email: email, password: password)
        
        //let parame = Clientes_Model(id: "", username: username, email: email, password: password)
        
        create_Model_2(for: parameters, in: .clientes)
    ...
    override func viewDidLoad() {
        ...
        plusPhotoButton.anchor(top: view.topAnchor, left: nil, bottom: nil, right: nil, paddingTop: 70, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 140, height: 140)
